...
{
public:
	struct ModelPatternInfo         // chứa thông tin của từng pix trong contours
	{
		Point2d Coordinates;
		Point2d Derivative;
		double Angle;
	...
	model();
	model(String pathTemplate, String modelName);
	model(String pathTemplate, String modelName, int pyramidDownLevel);
	~model();
	...
	// vector chứa thông tin của một contours
